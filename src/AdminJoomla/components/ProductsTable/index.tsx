...
import { ActionIcon, Avatar, Badge, Button, Checkbox, Select, Switch, Tooltip } from "rizzui";
...
import HeaderCell from "../../../Admin/components/HeaderCell";
...
const getColumns = (
    ...
    changeFilter: any
            ...
            render: (_: string, row: Product) => (
                <div className="flex items-center">
                    <div className="flex items-center gap-2">
                        ...
                        <LuArrowBigDownDash className="w-5 h-5" />
                    </div>
                </div>
            ),
        },

        {
            ...
            render: (_: string, row: Product) => (
                <div className="flex items-center">
                    <Switch checked={row.state} onChange={async () => {
                        try {
                            await ProductApi.changeState(
                                row.id
                            );
            ...
            render: (_: string, row: Product) => (
                <div className="flex items-center gap-2">
                    <Tooltip content={"product update"} color="invert" placement="top">
                        <Link to={"/joomla-admin/products/edit/" + row.id}>
