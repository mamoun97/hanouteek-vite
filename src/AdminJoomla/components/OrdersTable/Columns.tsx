...
import TimeLine from "../../../Admin/components/TimeLine";
import ItemsProductModal from "../../../Admin/components/ItemsProductModal";
    ...
    return [
        ...
        ...deleteCols.find(el => el == "state") ? [] : [{
            ...
            render: (_: string, row: OrderFull) => (
                <div className="flex justify-center ">
                    {row.state}
                    {/* <StateChange data={row} afterChange={afterChange} readOnly={true} /> */}
                </div>
            ),
        }],
