...
export function ProductPageType2({ data, isUpdate = false, index = -1, isSmall = false, onClose }:
    ...
    return <Container className={"mt-5 "}>
        <div className={"grid grid-cols-2 gap-4 max-md:grid-cols-1 "}>
            <div className="col-span-1">
                <ProductZoom data={data} detect={detect} type='type1' />
            </div>
            <div className="col-span-1">
                ...
                {prod.attribute.options.length ? <div className="mt-3  flex items-center gap-1">

                    <h2 className="font-bold">{prod.attribute.name || "Color"} : </h2>
                ...
                {
                    initSizes ? <div className="mt-2 flex items-center gap-1">
                        <h2 className="font-bold">{prod.attribute.optionsName || "Size"} :</h2>
                        <Attribute
                            typeAtt='type2'
                            setProduct={setProd}
                            product={prod}
