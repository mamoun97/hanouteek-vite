...
import { ActionIcon, Badge, Button as ButtonR, Modal } from "rizzui";
...
export function ProductPageType1({ data, isUpdate = false, index = -1, isSmall = false, onClose }:
    ...
    return <Container className={"mt-5 "}>
        <div className={"grid grid-cols-2 gap-4 max-md:grid-cols-1 "}>
            <div className="col-span-1">
                <ProductZoom type='type1' data={data} detect={detect} />
            </div>
            <div className="col-span-1">
                <div className='sticky top-16'>

                    <h1 className="text-3xl font-medium">{prod.name}</h1>
                    ...
                    {prod.hasOffer && prod.minNumberQteOffer && prod.priceOffer ? <OfferCard type='type1' prod={prod} /> : ""}


                    {prod.attribute.options.length ? <div className="mt-3">

                        <h2 className="font-medium ">{prod.attribute.name}</h2>
                    ...
                    </div> : ""}
                    {
                        initSizes ? <div className="mt-2">
                            <h2 className="font-medium ">{prod.attribute.optionsName}</h2>
                            <Attribute
                                typeAtt='type1'
                                setProduct={setProd}
                                product={prod}
