...
export default function Button({ children, isLoading = false, className = "", ...attributes }: InputProps) {
  return <button {...attributes} className={`text-gray-900 bg-white border border-gray-300 
    ...
    rounded-lg text-sm px-5 py-2.5  dark:bg-gray-800 dark:text-white dark:border-gray-600 
     dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700 ${className}`}>
    {
