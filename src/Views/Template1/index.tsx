    ...
    return (
        <div className='bg-[#ececec]' >
            <div className='min-h-screen bg-cover bg-center bg-no-repeat ' style={{
                backgroundImage: "url('https://static.wixstatic.com/media/c837a6_f58829a26e594ca3aa72383e19cf39b9~mv2.png/v1/fill/w_1470,h_848,al_r,q_90,usm_0.66_1.00_0.01,enc_auto/c837a6_f58829a26e594ca3aa72383e19cf39b9~mv2.png')"
            }}>
                <Container className='flex flex-col gap-4 justify-center items-start min-h-screen'>
                    ...
                    <h1 className='text-5xl tracking-wider max-w-md font-bold'>Incredible Prices on All Your Favorite Items</h1>
                    <p className='text-lg'>Get more for less on selected brands</p>
                    <Button className='min-w-[200px] rounded-full' size='lg'>
                        Shop Now
                    </Button>
                </Container>
            </div>

            <Container className='grid grid-cols-2 max-sm:grid-cols-1 gap-4 my-6'>
                {
                    [
                        {
                            ...
                            image: "https://static.wixstatic.com/media/c22c23_e140bfa8cd6f4cb2ac5ee6e204f64073~mv2.jpg/v1/fill/w_858,h_702,al_t,q_85,usm_0.66_1.00_0.01,enc_auto/c22c23_e140bfa8cd6f4cb2ac5ee6e204f64073~mv2.jpg"
                        },
                        {
                            subTitle: "Just In",
                            title: "Take Your Sound Anywhere",
                            desc: "Top Headphone Brands",
                            image: "https://static.wixstatic.com/media/c837a6_d84a631864a442a496670bc2d787c6a0~mv2.jpg/v1/fill/w_858,h_702,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/c837a6_d84a631864a442a496670bc2d787c6a0~mv2.jpg"
                        },
                    ].map((el, k) => {
                        return <div key={k} className='relative pt-[100%] bg-center bg-cover bg-no-repeat' style={{
                            backgroundImage: "url('" + el.image + "')"
                        }}>
                            <div className="absolute p-8 text-white inset-0  flex flex-col justify-center gap-3 items-start" >
                                <p className='text-lg'>{el.subTitle}</p>
                                <h1 className='text-5xl font-bold max-w-[240px]'>{el.title}</h1>
                                <p className='text-lg'>{el.desc}</p>
                                <Button className='rounded-full bg-white text-black min-w-[150px] '>
                                    Shop
                                </Button>
                            </div>
                        </div>
            ...
            <Container className='grid grid-cols-4 gap-2 bg-white p-6 max-md:grid-cols-2 max-sm:grid-cols-1'>
                {
                    [
                        {
                            icon: <svg className="h-10" preserveAspectRatio="xMidYMid meet" data-bbox="21 41.657 157.001 114.861" viewBox="21 41.657 157.001 114.861" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-label=""><defs></defs>
                                <g>
                        ...
                        {
                            icon: <svg className="h-10" preserveAspectRatio="xMidYMid meet" data-bbox="22 29.01 158 141.964" viewBox="22 29.01 158 141.964" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-label=""><defs></defs>
                                <g>
                        ...
                        {
                            icon: <svg className="h-10" preserveAspectRatio="xMidYMid meet" data-bbox="31.078 22 137.843 155.564" viewBox="31.078 22 137.843 155.564" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-label=""><defs></defs>
                                <g>
                        ...
                        {
                            icon: <svg className="h-10" preserveAspectRatio="xMidYMid meet" data-bbox="18.037 24.249 169.427 148.092" viewBox="18.037 24.249 169.427 148.092" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-label=""><defs></defs>
                                <g>
                        ...
                        return <div className='flex items-center gap-3 p-4 ' >
                            ...
                            <p className='font-semibold'>{el.text}</p>
                        </div>
                    })
                }
            </Container>

            <Container className='bg-white mt-6 py-8 overflow-hidden relative z-0'>
                <h1 className='text-2xl text-center font-bold mb-4'>
                    Best Sellers
                </h1>
                <div className="grid grid-cols-4 gap-4 max-sm:grid-cols-2 p-6">
                    {
                        data?.data.map((el, k) => {
                            return <ProductCard showFull={true} data={el} key={k} />
                        })
                    }
                </div>
                <div className="flex justify-center">
                    <Button className='rounded-full m-6 !mx-auto min-w-[220px] '>
                        View All
                    </Button>
                </div>
            ...
            <Container className='bg-white mt-6 py-8 overflow-hidden relative z-0'>
                ...
                <div className="grid grid-cols-5 gap-4 p-6 max-md:grid-cols-4 max-sm:grid-cols-2">
                    {
                        cats?.data.map((el, k) => {
                            return <div key={k}>
                                <div className='px-4'>
                                    <div className='relative border pt-[100%]  rounded-full bg-cover bg-no-repeat bg-center ' style={{
                                        backgroundImage: "url('https://static.wixstatic.com/media/c837a6_82b44061aa3e4ad6958d2a1ac317199c~mv2.jpg/v1/fill/w_124,h_124,q_90/c837a6_82b44061aa3e4ad6958d2a1ac317199c~mv2.jpg')"
                                    }}>

                                    </div>
                                </div>
                                <h1 className='line-clamp-1 text-lg font-semibold text-center mt-4 mx-2'>
                                    {el.name}
                                </h1>
                            </div>
                        })
            ...
            <Container className="mt-6" >
                <div className="bg-image h-screen grid grid-cols-5 max-sm:grid-cols-1 relative" style={{
                    backgroundImage: "url('https://static.wixstatic.com/media/c837a6_42dd66a436e846648736f4bc9546bf14~mv2.png/v1/fill/w_1775,h_900,al_c,q_90,usm_0.66_1.00_0.01,enc_auto/c837a6_42dd66a436e846648736f4bc9546bf14~mv2.png')"
                }}>
                    <div className="col-span-3 relative  h-screen overflow-hidden">

                        <div className="w-[120px] max-sm:w-full max-sm:h-[120px] absolute top-0 right-0 -bottom-1  max-sm:top-auto max-sm:left-0 bg-none bg-white [clip-path:polygon(0%_0%,_100%_0%,_100%_100%)] max-sm:[clip-path:polygon(100%_0%,_0%_100%,_100%_100%)]"></div>
                        <div className="absolute top-8 max-sm:top-auto max-sm:bottom-8 w-32 h-32 flex items-center flex-col font-semibold text-white justify-center text-2xl bg-red-600 rotate-12 rounded-full right-6">
                            <span>Best</span>
                            <span>Price</span>
                        </div>
                    </div>
                    <div className='col-span-2 max-sm:p-6 bg-white flex flex-col  items-start justify-center gap-6'>
                        <p className='text-3xl font-semibold'>Save up to</p>
                        <h1 className='text-6xl font-bold'>15000 DZD</h1>
                        <p className='text-2xl font-semibold'>on selected laptop
                            & tablets brands</p>
                        <p className='text-xl font-normal'>Terms and conditions apply</p>
                        <Button className='rounded-full   min-w-[220px] '>
                            Shop
                        </Button>
                    </div>
                </div>
