...
import ProfileJoomla from "./AdminJoomla/Pages/Profile";
...
export default function getRoutes(t: ThemeSetting) {
  return [
    ...
    {
      path: "/joomla-admin/profile",
      element: <LayoutAdminJoomla contentClassName="!p-0"><ProfileJoomla /></LayoutAdminJoomla>,
    },
    {
