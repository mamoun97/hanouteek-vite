...
export default function StatCards({ className }: { className?: string }) {
  return (
    <div
      className={cn('grid grid-cols-3 max-md:grid-cols-2 max-sm:grid-cols-1 gap-5 3xl:gap-8 4xl:gap-9', className)}
    >
      {eComDashboardStatData.map((stat) => (
        <MatricCard
          ...
          className="@container [&>div]:items-center dark:bg-[#000] dark:border-[#222]"
        >
