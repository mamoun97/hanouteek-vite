...
import { useGetAllOrdersStatisticsService } from '../../../Api/Services';
...
export default function SalesReport({ className }: { className?: string }) {
    ...
    return (
        <WidgetCard
            title={tr.dashboard.sales_report}
            description={
                <>
                    <Badge renderAsDot className="me-0.5 bg-[#282ECA]" /> {tr.dashboard.fresh}
                    <Badge
                        renderAsDot
