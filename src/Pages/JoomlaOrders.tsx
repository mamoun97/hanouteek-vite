...
import { states as associatStates, GestionStatus, returnStates, Substates } from "../Admin/Const/states"
...
import ProductSelect from "../Admin/components/ProductSelect"
import OrdersTable from "../AdminJoomla/components/OrdersTable/OrdersTable"
...
export default function Orders({ type = "default" }: { type?: OrderProsType }) {
  ...
  const [option, setOptions] = useState<OrderOptionRequest>({
    ...
    product: null,
    to_wilaya_name: "",
    state: paramSlugState.state ?? null
  })
