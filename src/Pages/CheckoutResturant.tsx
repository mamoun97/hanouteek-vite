...
const validationS = (dt: Erros) => Yup.object().shape({
    ...
    address: Yup.string().required(dt.address),
    nots: Yup.string()
});
export default function CheckoutResturant() {
    ...
    const register = (p: "fullName" | "contact_phone" | "to_wilaya_name" | "to_commune_name" | "nots"|"address") => {
        return {
                ...
                : <div className="flex flex-col items-center mt-6">
                    ...
                    <div className="p-3 border border-gray-200 rounded-md w-full max-w-4xl mt-2">
                        ...
                        <div className="flex items-center ">
                            ...
                            <div className="grow"></div>
                            <div className="font-semibold">{(modeDelivery.find(el => el.check)?.cost ?? 0).toFixed(2)} <Currency /></div>
                        </div>
                        <div className="flex items-center ">
